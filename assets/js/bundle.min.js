...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Reactions = __webpack_require__(/*! ./reactions/Reactions */ 79);
	
	var _Reactions2 = _interopRequireDefault(_Reactions);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	window.React = __webpack_require__(/*! react */ 62);
	window.ReactDOM = __webpack_require__(/*! react-dom */ 80);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _tradestable = __webpack_require__(/*! ./tradestable.jsx */ 60);
	
	var _tradestable2 = _interopRequireDefault(_tradestable);
	
	var _fakeChart = __webpack_require__(/*! ./fakeChart.jsx */ 89);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ordersState = __webpack_require__(/*! ./ordersState */ 86);
	
	var _ordersState2 = _interopRequireDefault(_ordersState);
	
	var _chartState = __webpack_require__(/*! ./chartState */ 88);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _griddleReact = __webpack_require__(/*! griddle-react */ 61);
	
	var _griddleReact2 = _interopRequireDefault(_griddleReact);
	
	var _datedisplay = __webpack_require__(/*! ./datedisplay.jsx */ 81);
	
	var _datedisplay2 = _interopRequireDefault(_datedisplay);
	
	var _tradetablebuttons = __webpack_require__(/*! ./tradetablebuttons.jsx */ 82);
	
	var _tradetablebuttons2 = _interopRequireDefault(_tradetablebuttons);
	
	var _initconfig = __webpack_require__(/*! ../utils/initconfig */ 78);
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var GridTable = __webpack_require__(/*! ./gridTable.jsx */ 63);
	var GridFilter = __webpack_require__(/*! ./gridFilter.jsx */ 69);
	var GridPagination = __webpack_require__(/*! ./gridPagination.jsx */ 70);
	var GridSettings = __webpack_require__(/*! ./gridSettings.jsx */ 71);
	var GridNoData = __webpack_require__(/*! ./gridNoData.jsx */ 72);
	var GridRow = __webpack_require__(/*! ./gridRow.jsx */ 73);
	var CustomRowComponentContainer = __webpack_require__(/*! ./customRowComponentContainer.jsx */ 75);
	var CustomPaginationContainer = __webpack_require__(/*! ./customPaginationContainer.jsx */ 76);
	var CustomFilterContainer = __webpack_require__(/*! ./customFilterContainer.jsx */ 77);
	var ColumnProperties = __webpack_require__(/*! ./columnProperties */ 66);
	var RowProperties = __webpack_require__(/*! ./rowProperties */ 68);
	var deep = __webpack_require__(/*! ./deep */ 74);
	var _ = __webpack_require__(/*! underscore */ 65);
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var React = __webpack_require__(/*! react */ 62);
	var GridTitle = __webpack_require__(/*! ./gridTitle.jsx */ 64);
	var GridRowContainer = __webpack_require__(/*! ./gridRowContainer.jsx */ 67);
	var ColumnProperties = __webpack_require__(/*! ./columnProperties.js */ 66);
	var RowProperties = __webpack_require__(/*! ./rowProperties.js */ 68);
	var _ = __webpack_require__(/*! underscore */ 65);
	    ...
	    if (that.state.showChildren) {
	      children = that.props.hasChildren && this.props.data["children"].map(function (row, index) {
	        if (typeof row["children"] !== "undefined") {
	          var Griddle = __webpack_require__(/*! ./griddle.jsx */ 61);
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var _ = __webpack_require__(/*! underscore */ 65);
	var ColumnProperties = __webpack_require__(/*! ./columnProperties.js */ 66);
	var deep = __webpack_require__(/*! ./deep.js */ 74);
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(/*! ./ordersReactions */ 85);
	
	__webpack_require__(/*! ./chartsReactions */ 87);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _gimmenum = __webpack_require__(/*! ../utils/gimmenum */ 84);
	
	var _gimmenum2 = _interopRequireDefault(_gimmenum);
	
	var _gettradetype = __webpack_require__(/*! ../utils/gettradetype */ 83);
...
/***/ function(module, exports) {
	...
	var ordersState = [{ ticket: 221, type: 6, round: 1, open: 0.067, close: 0.061, expiry: 1, 'open time': 1455196729354, 'close time': 1455196729355, 'bet amount': 10, 'potential payout': 1, 'profit/loss': '$10' }, { ticket: 222, type: 6, round: 1, open: 0.061, close: 0.07, expiry: 1, 'open time': 1455197040728, 'close time': 1455197040728, 'bet amount': 5, 'potential payout': 1, 'profit/loss': '-$5' }, { ticket: 223, type: 6, round: 1, open: 0.07, close: 0.065, expiry: 1, 'open time': 1455197048016, 'close time': 1455197048016, 'bet amount': 5, 'potential payout': 1, 'profit/loss': '$5' }, { ticket: 221, type: 6, round: 1, open: 0.067, close: 0.061, expiry: 1, 'open time': 1455196729354, 'close time': 1455196729355, 'bet amount': 10, 'potential payout': 1, 'profit/loss': '$10' }, { ticket: 222, type: 6, round: 1, open: 0.061, close: 0.07, expiry: 1, 'open time': 1455197040728, 'close time': 1455197040728, 'bet amount': 5, 'potential payout': 1, 'profit/loss': '-$5' }, { ticket: 223, type: 6, round: 1, open: 0.07, close: 0.065, expiry: 1, 'open time': 1455197048016, 'close time': 1455197048016, 'bet amount': 5, 'potential payout': 1, 'profit/loss': '$5' }, { ticket: 221, type: 6, round: 1, open: 0.067, close: 0.061, expiry: 1, 'open time': 1455196729354, 'close time': 1455196729355, 'bet amount': 10, 'potential payout': 1, 'profit/loss': '$10' }, { ticket: 222, type: 6, round: 1, open: 0.061, close: 0.07, expiry: 1, 'open time': 1455197040728, 'close time': 1455197040728, 'bet amount': 5, 'potential payout': 1, 'profit/loss': '-$5' }, { ticket: 223, type: 6, round: 1, open: 0.07, close: 0.065, expiry: 1, 'open time': 1455197048016, 'close time': 1455197048016, 'bet amount': 5, 'potential payout': 1, 'profit/loss': '$5' }];
...
/* 87 */
/*!*********************************************!*\
  !*** ./src/js/reactions/chartsReactions.js ***!
  \*********************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	_AppState2.default.on('chart:setHistoryMode', function (historyTradeData) {
		_AppState2.default.get().chartState.set({ historyTrade: historyTradeData });
	});
